...
function Final() {
    ...
    const flag_a ="https://t3.ftcdn.net/jpg/01/17/57/26/240_F_117572666_FeneGZAZbbAYhfPcVvHuDBCsRzVpTHeY.jpg"
        ...
        <Grid xs={12} sm={12} justify="center">
          ...
          <Card css={{ mw: "450px" }} cardvariants = 'shadow'>
            ...
            <Card.Footer>
              <Row justify="center">
                <div>
                    <Link href="https://www.youtube.com/watch?v=YkCz8d3xxAM" isExternal target="_blank">
